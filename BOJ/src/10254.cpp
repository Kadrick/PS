...
int main(void)
{
    ...
    while (tc--)
    {
            ...
            -> int
        {
            ...
            long long zVal = cross(baseVec, targetVec);
        ...
        if (cvHull.size() == 2)
        {
            cout << cvHull[0].x << ' ' << cvHull[0].y << ' '
                 << cvHull[1].x << ' ' << cvHull[1].y << endl;
            continue;
        }
        ...
        cout << cvHull[ans.first].x << ' ' << cvHull[ans.first].y << ' '
             << cvHull[ans.second].x << ' ' << cvHull[ans.second].y << endl;
    }
